PUF Technical Acknowledgement is a document type that is applicable to be exchanged between Pagero and supplier/issuer to inform the issuer of an invoice about the trasport of a message
